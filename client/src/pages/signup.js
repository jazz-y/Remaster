...
const Signup = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('http://ec2-18-216-254-218.us-east-2.compute.amazonaws.com:3001/auth/signup', {
        email,
        username,
        password,
      });
  ...
  return (
    <>
      ...
      <div style={pagestyle}>
        <h1>Sign up</h1>
        <input type="text" placeholder="Email" onChange={(e) => setEmail(e.target.value)} style={inputstyle} />
